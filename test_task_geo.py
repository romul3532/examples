...
# arbitrary_point=[4,4,5] ### координаты произвольной наблюдаемой точки, точки друг друга не видят
arbitrary_point=[-0.5,1,1] ### координаты произвольной наблюдаемой точки , точки друг друга видят

'''
комбинации:
    1) vertices_triangle=[[0,2,3],[-1,5,3],[-1,2,9]] ### вершины треугольника
       vertices_observer=[0,0,0] ### координаты наблюдателя
       arbitrary_point=[-0.5,1,1] ### координаты произвольной наблюдаемой точки, точки друг друга видят
    2) vertices_triangle=[[0,2,3],[-1,5,3],[-1,2,9]] ### вершины треугольника
       vertices_observer=[0,0,0] ### координаты наблюдателя
       arbitrary_point=[4,4,5] ### координаты наблюдателя , точки друг друга не видят
'''
...
def get_mutual_arrangement(vertices_triangle,vertices_observer,arbitrary_point):
    ...
    def get_relative_position_normals(direction_vector,normal_plane):
        ...
        if mutual_arrangement==0: ## прямая не пересекает треугольник , значит две точки друг друга видят
